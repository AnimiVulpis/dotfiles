...
if [[ ! -e ~/external-repos/atuin ]]; then
    ...
    atuin init --disable-ai zsh > ~/external-repos/atuin/atuin.init.zsh
    atuin hex init zsh > ~/external-repos/atuin/atuin.hex.init.zsh
    zcompile-many ~/external-repos/atuin/atuin.init.zsh
    zcompile-many ~/external-repos/atuin/atuin.hex.init.zsh
fi
...
# `atuin.hex.init.zsh` is generated by `atuin hex init zsh > atuin.hex.init.zsh` (used for using the experimental lightweight PTY proxy)
...
source ~/external-repos/atuin/atuin.hex.init.zsh
...
# Define yazi wrapper (from https://yazi-rs.github.io/docs/quick-start#shell-wrapper)
function y() {
...
alias nlg="nuls --git"
alias nla="nuls --all"
alias nlam="nuls --sort-modified --all"
alias nlag="nuls --git --all"
alias nlamg="nuls --git --sort-modified --all"
