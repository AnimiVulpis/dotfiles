...
echo '\e[34mExecuting\e[0m "\e[32mcargo \e[37minstall bat broot click eva exa fd-find find_unicode genact git-delta hyperfine ncspot swaysome sworkstyle tidy-viewer \e[0m"'
cargo install \
    bat \
    broot \
    click \
